...
/**
 *  The TextFiled class will display a prompt over top of a text component when
 ...
 *  class construction.
 */
public class TextFiled extends JLabel
	implements FocusListener, DocumentListener
{
	...
	public TextFiled(String text, JTextComponent component)
	{
		this(text, component, Show.ALWAYS);
	}

	public TextFiled(String text, JTextComponent component, Show show)
	{
